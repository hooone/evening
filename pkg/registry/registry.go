...
//Descriptor : Services Name and Instance
...
//RegisterService register service instance
...
//GetServices get all registed services
...
//OverrideServiceFunc interface define
...
// are expected to forfill to be started within evening.
type Service interface {

	// Init is called by evening main process which gives the service
...
type BackgroundService interface {
	...
	// to subscribe to ctx.Done() so the service can be notified when evening shuts down.
