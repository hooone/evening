...
func AddUserMigration(mg *migrator.Migrator) {
	userV1 := migrator.Table{
		...
		Columns: []*migrator.Column{
			...
			{Name: "last_seen_at", Type: migrator.DB_DateTime, Nullable: false},
	...
	adminUserSql := "INSERT INTO `user` (`version`, `login`, `email`, `name`, `password`, `salt`, `rands`, `company`, `org_id`, `is_admin`, `email_verified`, `theme`, `last_seen_at`, `created`, `updated`) VALUES ('1','admin', 'admin@localhost', 'admin', 'b649b8e44204e86004d027e0d57540c130d125520ab14534d132c08edb0d7bfc5c6c6dd3204c4cd0b31432aa8f43972636cc', 'grmKEzb4SU', 'EgIzpGxfud', '1', '1', '1', '1', '1','2020-01-01 00:00:00', '2020-01-01 00:00:00', '2020-01-01 00:00:00')"
